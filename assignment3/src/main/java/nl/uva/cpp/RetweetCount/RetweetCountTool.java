...
public class RetweetCountTool extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.setMapperClass(RetweetCountMapper.class);
		job.setReducerClass(RetweetCountReducer.class);
