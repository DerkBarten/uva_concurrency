        ...
        double *old_array, double *current_array, double *next_array)
{
    ...
    #pragma omp parallel for private(i,j) firstprivate(old_array, current_array, next_array) if(t_max >= 20000) 
    #pragma omp scheduling(guided, 1) // j is private to the inner loop
